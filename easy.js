...
function forEvery(list, item, func) {
...
function forEveryElementInClass(cls, func) {
  var l = document.getElementsByClassName(cls);
  forEvery(l, l[1].getAttribute("class"), func);
}

function saveFile(data, fileName, extension) {
  //By Awesomeness01
  var file = new Blob([data], {extension: extension});
